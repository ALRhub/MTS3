...
from experiments.exp_simple_prediction_mts3 import Experiment
...
def my_app(cfg)->OmegaConf:
    ...
    ### train the model
    mts3_model, wandb_run, save_path = exp._train_timeseries_model(train_obs, train_targets, test_obs, test_targets)
    ### test the model
    #TODO: normalizer format specify
    exp._test_timeseries_model(test_obs, test_targets, normalizer, mts3_model, wandb_run, save_path)
